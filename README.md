## A Starbucks-inspired Next.js application (for learning purposes)
...
---  
## 📚 What I Learned
- Writing production-ready Jenkins pipelines
- Docker image optimization for Next.js apps
- Deploying and monitoring workloads on EKS
- Implementing DevSecOps using Trivy and OWASP practices
